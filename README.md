...
<!-- TYPING -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=16&duration=3000&pause=800&color=FFFFFF&background=00000000&center=true&vCenter=true&width=680&height=40&lines=AI+Agents+%7C+LLMs+%7C+Cryptography;2M+Ecosystem+%7C+Bangladesh;If+it+shouldnt+work+Im+making+it+work." alt="Typing SVG" />
...
> currently_building
  ...
  2M Code    ──  Coding tool  [ Go 52.6% · Python 44.5% · Shell 2.4%         ]
```
...
|:---:|:---|:---|:---|
| 🦾 | **[2MClaw AI](https://github.com/ArafatAhmed-2M/2MClawAI)** | AI agent for intelligent task automation | ![TS](https://img.shields.io/badge/TS-000?style=flat-square&logo=typescript&logoColor=fff) ![HTML](https://img.shields.io/badge/HTML-000?style=flat-square&logo=html5&logoColor=fff) ![JS](https://img.shields.io/badge/JS-000?style=flat-square&logo=javascript&logoColor=fff) |
| 🛠️ | **[2M Code](https://github.com/ArafatAhmed-2M/2M-Code)** | Custom coding tool built from scratch | ![Go](https://img.shields.io/badge/Go-000?style=flat-square&logo=go&logoColor=fff) ![Python](https://img.shields.io/badge/Python-000?style=flat-square&logo=python&logoColor=fff) |
| 🔒 | **[2mencrypther](https://github.com/ArafatAhmed-2M/2mencrypther)** | Encryption tool — sharp and focused | ![TS](https://img.shields.io/badge/TS_90%25-000?style=flat-square&logo=typescript&logoColor=fff) ![CSS](https://img.shields.io/badge/CSS-000?style=flat-square&logo=css3&logoColor=fff) |
| 🎙️ | **[OmniVoice TTS](https://github.com/ArafatAhmed-2M/OmniVoice-ZeroShot-TTS)** | Zero-shot TTS and voice cloning — 600+ languages | ![Jupyter](https://img.shields.io/badge/Jupyter-000?style=flat-square&logo=jupyter&logoColor=fff) ![Python](https://img.shields.io/badge/Python-000?style=flat-square&logo=python&logoColor=fff) |
| 🎨 | **[2M AI Studio](https://github.com/ArafatAhmed-2M/2maistudio)** | AI studio — Part of the 2M Ecosystem | ![TS](https://img.shields.io/badge/TS_96%25-000?style=flat-square&logo=typescript&logoColor=fff) ![CSS](https://img.shields.io/badge/CSS-000?style=flat-square&logo=css3&logoColor=fff) |
| 📚 | **[Free Notebooks](https://github.com/ArafatAhmed-2M/Free-NoteBooks-ColabKaggle)** | Production AI notebooks for Colab and Kaggle T4 | ![Jupyter](https://img.shields.io/badge/Jupyter-000?style=flat-square&logo=jupyter&logoColor=fff) ![Python](https://img.shields.io/badge/Python-000?style=flat-square&logo=python&logoColor=fff) |
